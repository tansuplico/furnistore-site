    ...
    <aside className="hidden w-[25%] lg:flex flex-col justify-center items-center gap-5">
      <div className="w-full bg-white">
        ...
        <div className="w-full">
          <div className="w-full flex px-3 pt-3 pb-2 justify-between items-center cursor-pointer hover:bg-[#00A693] hover:text-white transition-all">
            <Link to="/collections">
              <h1> Collections </h1>{" "}
            </Link>
            <img
          ...
          <div
            className={`w-full mt-2  ${
              accordion.includes(1) ? "h-[8rem] px-3 pt-3 pb-2" : "h-auto"
        ...
        <div className="w-full ">
          <div className="w-full px-3 pt-3 pb-2 flex justify-between items-center hover:bg-[#00A693] hover:text-white transition-all cursor-pointer">
            <Link to="/shop">
              <h1> Shop </h1>
            </Link>
            <img
          ...
          <div
            className={`w-full mt-2 ${
              accordion.includes(2) ? "h-[8rem] px-3 pt-3 pb-2" : "h-auto"
            } overflow-hidden relative transition-all`}
          >
            <ul
              className={`w-full flex flex-col gap-2 absolute text-[.9rem] duration-500 ${
        ...
        <div className="w-full ">
          ...
          <div
            className={`w-full mt-2 ${
              accordion.includes(3) ? "h-[8rem] px-3 pt-3 pb-2" : "h-auto"
            } overflow-hidden relative transition-all`}
          >
            <ul
              className={`w-full flex flex-col gap-2 absolute text-[.9rem] duration-500 ${
